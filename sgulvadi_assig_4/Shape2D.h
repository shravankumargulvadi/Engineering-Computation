...
public:
	...
	bool addPoint(Point2D newPoint, int index); //done
	...
	// Returns -1 if no near vertex is found
	// Hint : if point beyond upper or lower bound - no point even checking
